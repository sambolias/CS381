...
Useful references for planets, are their shaders, function drawPlanet(planet), function genHeightMap(size), and other nearby functions depending on your level of curiosity.
